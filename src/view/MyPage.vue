<template>
  ...
  <div class="bg-zinc-50 min-h-screen">
    <div class="max-w-4xl mx-auto pt-24">
          ...
          <div class="md:px-24 flex flex-col space-y-6">
            ...
            <div class="flex items-center space-x-5">
              ...
              <div class="border rounded md:flex items-center hidden">
                <router-link
                  to="/edit"
                  class="text-sm font-bold px-2 py-1"
                >프로필 편집</router-link>
              </div>
            </div>
            <!-- responsive1 -->
            <div class="border rounded flex items-center justify-center md:hidden">
              <router-link
                to="/edit"
                class="text-sm font-bold px-24 py-1"
              >프로필 편집</router-link>
            </div>
            <!-- 2nd row -->
      ...
      <div
        v-show="myPostCount >= 1"
        class="grid grid-cols-3 gap-7"
      >
        <div
          v-for="(myImages,post_no) in myPostList"
          :key="post_no"
          class="cursor-pointer relative"
          @click="getPostList(post_no)"
        >
          <img
            class="w-full h-full drop-shadow-lg"
            :src="myImages.p_filename"
      ...
      <div
        v-show="myPostCount === 0"
        class="h-96 text-center bg-zinc-50 pt-12 pb-14 "
      >
        ...
        <div class="bg-white rounded text-xl my-5">
          <div class="flex">
            ...
            <div class="w-7/12 border-r">
              <img
                class="h-full w-full"
                :src="myPostDetailList.pfilename"
                @error="replaceByDefault"
              >
            </div>
            <!-- content -->
            <div class="flex-1 flex flex-col justify-between">
              ...
              <div class="flex items-center justify-between px-4 py-3 border-b">
                <div class="flex items-center">
                  <img
                    :src="myPostDetailList.mfilename"
              ...
              <div class="flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide">
                ...
                <div class="flex px-4 py-3 w-full">
                  <div class="flex w-full items-start">
                    ...
                    <div class="flex-1 flex flex-col">
                      ...
                      <!-- eslint-disable -->
                      <textarea class="focus:outline-none inline line-clamp-2 text-sm resize-none">{{myPostDetailList.content}}</textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="flex flex-col h-64 px-4 pt-3 space-y-6">
                  <div
                    ...
                    class="flex space-x-4 w-full items-start"
                  >
                    <img
                    ...
                    <div
                      v-if="(memberNo != this.$store.memberNo)===false"
              ...
              <div class="px-3 py-4 border-t">
                ...
                <div class="flex justify-between">
                  <div class="flex space-x-3 items-center">
                    <div
                      @click="likesUP(myPostDetailList.postNo, 'Y')"
                      v-if="myPostDetailList.likeStatus"
                    >
                      <svg
                        aria-label="좋아요 취소"
                        color="#ed4956"
                    ...
                    <div
                      @click="likesUP(myPostDetailList.postNo, 'N')"
                      v-else
                    >
                      <svg
                        aria-label="좋아요"
    ...
    >
      <div class="bg-white rounded-lg z-50 w-96">
        <div class="flex flex-col w-ful">
          <div
            class="cursor-pointer border-b border-gray-300 py-3 w-full text-center text-red-500 font-semibold"
            @click="removePost"
          >삭제</div>
          <div
            class="cursor-pointer py-3 w-full text-center"
            @click="toggleModal"
            :modalActive="false"
          >취소</div>
        </div>
...
export default {
    ...
    methods: {
        ...
        likesUP(pNo, delYn) {
            // console.log(this.post_no, delYn, pNo)
            axios.post ("/api/v1/comment/likePost",{
                ...
                this.myPostDetailList.likeCnt= likeCnt
                this.myPostDetailList.likeStatus= likeStatus
        ...
        getPostList(index) {
            ...
            axios.get("/api/v1/post/getPost" ,{
                ...
                this.myPostDetailList = _data;
                if (res.data.data) {
                    this.myPostDetailList.likeStatus = (_data.likeFlag === 'N') ? true:false
                }
