                            ...
                            <div class="px-3 py-4 border-t">
                                ...
                                <div class="flex justify-between">
                                    <div class="flex space-x-3 items-center">
                                        <div @click="likesUP(myPostDetailList.postNo, 'Y')" v-if="myPostDetailList.likeStatus">
                                        ...
                                        <div @click="likesUP(myPostDetailList.postNo, 'N')" v-else>
                                        ...
                                        <!--
                                        <svg class="hover:opacity-60 cursor-pointer" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
