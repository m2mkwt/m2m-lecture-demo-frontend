                  ...
                  <div class="flex w-full items-start">
                    ...
                    <div class="flex-1 flex flex-col">
                      ...
                      <textarea
                        ...
                        @keyup.enter.exact="submitUpdatedPost"
                      ></textarea>
                    </div>
                  </div>
                </div>
    ...
    >
      <div class="bg-white rounded-lg z-50 w-96">
        <div class="flex flex-col w-ful">
          ...
          >삭제</div>
          <div
            class="cursor-pointer border-b border-gray-300 py-3 w-full text-center"
            @click="[updatePost(), toggleModal()]"
          >수정</div>
          <div
