<template>
    ...
    <base-dialog :dialog-active="dialogActive" @close="toggleDialog">
      <div class="w-full z-40 h-max px-10 max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded text-xl h-full">
          ...
          <!-- content -->
          <div class="flex">
              <div v-if="mediaNo == 0" class="flex-1 z-50 cursor-pointer flex flex-col justify-center items-center" @click.prevent.self="$refs.uploadfile.click();">
