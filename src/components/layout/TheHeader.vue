    ...
    <base-dialog @close="toggleDialog" :dialogActive="dialogActive">
      <div class="w-full z-40 h-max px-10 max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded text-xl h-full">
          ...
          <!-- content -->
          <div class="flex">
            <div @click.prevent.self="this.$refs.uploadfile.click();" class="flex-1 z-50">
              <input ref="uploadfile" class="opacity-0 w-full h-full cursor-pointer" @change="handleFileChange" type="file" />
              <!-- <div @click.prevent.self="this.$refs.uploadfile.click();" class="cursor-pointer w-full h-full flex flex-col justify-center items-center">
                <div>
                  ...
                  <p>사진과 동영상을 여기에 업로드하세요</p>
                </div>
                <input ref="uploadfile" class="hidden" @change="handleFileChange" type="file" />
              </div> -->
              <!-- <div v-else>
