        ...
        <div class="max-w-4xl mx-auto pt-24">
            <div class="bg-white w-full border flex">
                ...
                <div class="w-1/4 border-r hidden md:block">
                    <div class="py-4 px-7 cursor-pointer border-l-2 border-black w-full font-semibold">프로필 편집</div>
                        ...
                        <div class="flex space-x-6">
                            ...
                            <div class="flex-1 flex flex-col space-y-3">
                                <div>
                                    ...
                                    <textarea class="rounded border w-full" name="" id="" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- 이메일 -->
